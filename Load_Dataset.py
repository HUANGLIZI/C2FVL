...
class ImageToImage2D(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #image_filename = self.images_list[idx]  # COVID_CT
        #mask_filename = image_filename[: -3] + "png"  # COVID_CT
        mask_filename = self.mask_list[idx]  # Cov19
        image_filename = mask_filename.replace('mask_', '')  # Cov19
        ...
        text=[]
        for i in range(8):
          text.append(self.rowtext[i][mask_filename])
        #print('Load Dataset text:',text)
        text=np.expand_dims(text,0)
        #print('after expands text:',text)
